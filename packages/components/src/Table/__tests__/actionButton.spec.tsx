...
describe('ActionButton', () => {
  ...
  it('renders "更多" dropdown when there are hidden actions', () => {
    ...
    render(<ActionButton record={mockRecord} actions={customActions} maxVisible={3} index={0} />);
  ...
  it('renders custom actions correctly', () => {
    const customActions = [
      { key: 'custom', text: 'Custom Action' },
    ];

    render(<ActionButton record={mockRecord} actions={customActions} index={0} />);
  ...
  it('applies custom render function for buttons', () => {
    ...
    const { container} = render(<ActionButton record={mockRecord} renderButton={customRenderButton} index={0} />);
  ...
  it('handles dynamic maxVisible prop', () => {
    ...
    render(<ActionButton record={mockRecord} maxVisible={dynamicMaxVisible} index={0} />);
